...
ALIGNMENT='/data/schwartzlab/Biancani/output_SISRS/mammals/SISRS_Run/alignment_pi_m10_nogap.rmNseqs.phylip-relaxed' #Put the path to your alignment file here
